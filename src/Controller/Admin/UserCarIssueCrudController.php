...
class UserCarIssueCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return UserCarIssue::class;
    }
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            ...
            ->setEntityLabelInSingular('Car Issue')
            ->setEntityLabelInPlural('Car Issues')
        ;
    }
