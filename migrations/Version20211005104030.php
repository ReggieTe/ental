 ...
 */
final class Version20211005104030 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE date_created date_created DATETIME DEFAULT NULL, CHANGE date_updated date_updated DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE date_created date_created DATETIME NOT NULL, CHANGE date_updated date_updated DATETIME NOT NULL');
